...
@section('content')
    ...
    <section class="accordion">
        <div class="questions">
            ...
            <div class="question">
                <a href="#answer-1" class="question-title">How to connect my Welasensor to my Wi-Fi</a>
            ...
            <div class="question">
                <a href="#answer-2" class="question-title">How to add my Welasensor to my cloud app account</a>
            ...
            <div class="question">
                <a href="#answer-3" class="question-title">How to get reports to my email address</a>
            ...
            <div class="question">
                <a href="#answer-4" class="question-title">I don't get any data to my cloud app, but sensor is added and it is active</a>
